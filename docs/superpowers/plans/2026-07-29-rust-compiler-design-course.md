...
- [ ] #5 Especificar gramática, precedencia, recuperación y alternativas.
- [ ] #6 Implementar y probar parser con precedencia y diagnósticos.
...
- [ ] #11 Especificar símbolos, scopes, tipos y diagnósticos semánticos.
...
- [ ] #14 Especificar IR, bloques, instrucciones y contrato de lowering.
